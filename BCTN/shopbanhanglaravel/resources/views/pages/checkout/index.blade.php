    ...
    <header class="header">
        ...
        <div class="header_content d-flex flex-row align-items-center justify-content-start">
            ...
            <div class="header_right d-flex flex-row align-items-center justify-content-start ml-auto">
                ...
                <!-- User -->
                <div class="user">
                    {{-- <a href="{{URL::to('/login-checkout')}}"><div><img src="{{asset('public/frontend/LittleCloset/images/user.svg')}}" alt="https://www.flaticon.com/authors/freepik"><div>1</div></div></a> --}}
                    <?php
                        $customer_id = Session::get('customer_id');
                        if($customer_id != Null){
                    ?>

                        <a href="{{URL::to('/logout-checkout')}}"><div><img src="{{asset('public/frontend/LittleCloset/images/user.svg')}}" alt="https://www.flaticon.com/authors/freepik"><div>1</div></div></a>
