...
class BrandProduct extends Controller
{
    ...
    public function save_brand_product(Request $request){
    	...
    	$data['brand_des'] = $request->category_product_des;
    	$data['brand_status'] = $request->category_product_status;

    	DB::table('tbl_brand')->insert($data);
    	Session::put('message','Add product brand success');
    ...
    public function update_brand_product(Request $request, $brand_product_id){
        ...
        Session::put('message_up_brand', 'Update product brand success');
        return Redirect::to('all-brand-product');
    ...
    public function delete_brand_product($brand_product_id){
        ...
        Session::put('message_del_brand', 'Delete product brand success');
        return Redirect::to('all-brand-product');
    }
