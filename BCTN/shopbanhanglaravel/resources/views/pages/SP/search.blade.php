    ...
    <header class="header">
        ...
        <div class="header_content d-flex flex-row align-items-center justify-content-start">
            ...
            <div class="header_right d-flex flex-row align-items-center justify-content-start ml-auto">
                ...
                <!-- User -->
                <div class="user"><a href="#"><div><img src="{{asset('public/frontend/LittleCloset/images/user.svg')}}" alt="https://www.flaticon.com/authors/freepik"><div>1</div></div></a></div>
                <!-- Cart -->
            ...
            <div class="container">
                ...
                <div class="row products_row products_container grid">
                    ...
                    <div class="col-xl-4 col-md-6 grid-item new">
                        <div class="product">
                            <a href="{{URL::to('/chitietSP/'.$product->product_id)}}">
                            <div class="product_image"><img src="{{URL::to('public/uploads/product/'.$product->product_image)}}" alt="" style="width: 350px;height: 450px;"></div>
                            <div class="product_content">
                                <div class="product_info d-flex flex-row align-items-start justify-content-start">
                                    <div>
                                        <div>
                                            ...
                                            <div class="product_category">In <a href="{{URL::to('/danhmucSP/'.$cate->category_id)}}">{{$cate->category_name}}</a></div>
                                                @endif
                                            @endforeach
                                        </div>
                                    </div>
                                ...
                                {{-- <img src="{{URL::to('public/uploads/product/'.$product->product_image)}}" alt="" height="250" /> --}}
