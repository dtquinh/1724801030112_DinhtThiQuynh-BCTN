...
class CategoryProduct extends Controller
{
    ...
    public function save_category_product(Request $request){
    	...
    	Session::put('message','Add product catalog successful');
    ...
    public function update_category_product(Request $request, $category_product_id){
        ...
        Session::put('message_up_cate', 'Update the list of products successfully');
        return Redirect::to('all-category-product');
    ...
    public function delete_category_product($category_product_id){
        ...
        Session::put('message_del_cate', 'Delete product catalog successfully');
        return Redirect::to('all-category-product');
    }
    ...
    public function show_category_home($category_id){
        ...
        $category_name = DB::table('tbl_category_product')->where('tbl_category_product.category_id',$category_id)->limit(12)->get();


        return view('pages.category.show_category')->with('category', $cate_product)->with('brand', $brand_product)->with('category_by_id', $category_by_id)->with('category_name',$category_name); //->with('brand_by_id', $brand_by_id)
